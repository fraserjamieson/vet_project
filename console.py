...
zero = Animal("Zero", "13/10/2018", "Dog", "01382", "Visited to recieve yearly jab", halopetcare)
animal_repository.save(zero)

beethoven = Animal("Beethoven", "13/11/2018", "Dog", "01382", "Poor thing had soft case of the runs.  Was displaying troubling symptons of something more serious, but aptly treated with relevant antibiotics", halopetcare)
